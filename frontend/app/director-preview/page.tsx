...
import {
    TrendingUp, DollarSign, ShoppingBag, Users, Warehouse,
    Building2, Filter, Download, ChevronRight, Eye, AlertCircle,
    CheckCircle2, Clock, Activity, BarChart3, PieChart as PieIcon,
    Layers, Zap, ArrowUpRight, Sparkles, X, ShieldAlert, FileSpreadsheet, ArrowLeft
} from "lucide-react";
import {
        ...
        <div className="min-h-screen bg-slate-50 p-4 md:p-8">
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div className="flex items-center justify-between bg-white px-6 py-4 rounded-2xl shadow-sm border border-gray-100">
                    <Link href="/" className="flex items-center gap-2 text-xs font-semibold text-gray-600 hover:text-indigo-600 transition-colors">
                        <ArrowLeft size={16} /> Back to Storefront
                    </Link>
                    <div className="flex items-center gap-2">
                        <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-amber-50 text-amber-700 border border-amber-200">
                            🔒 Public Executive Preview Mode (No Login Required)
                        </span>
                    </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                    <div>
                        ...
                        <h1 className="text-2xl md:text-3xl font-extrabold text-gray-900 tracking-tight">
                            Executive Analytics & Oversight Dashboard
                        </h1>
                        <p className="text-sm text-gray-500 mt-1">
                            Comprehensive multi-branch performance metrics, financial forecasts, and operational health drill-downs. Click any section for instant audit.
                        </p>
                    </div>
